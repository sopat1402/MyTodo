...
function Rightbar(props){
    ...
    return (
        <div className="fixed top-[10%] right-0 hidden flex-col sm:flex sm:w-[30%] h-full bg-[#3B7597]">
            ...
            <h2 className='ml-3 my-2 text-2xl'><input type="text" value={props.task.title} onChange={(e) => props.task.title = e.target.value}/></h2>
            <p className='w-[80%] m-auto'>{props.task.description}</p>
