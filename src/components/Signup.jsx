        ...
        <>
            ...
            <div className="w-full h-[90vh] mt-[10vh] flex flex-col bg-[#3B7597] justify-center items-center">
                <form className="relative rounded-md bg-[#093C5D] flex flex-col w-[max(25%,300px)] p-5 space-y-5" onSubmit={handleSubmit}>
                    ...
                    <input type="email" name="email" className="bg-[#093C5D] rounded-md mx-[auto] pl-3 border-white h-[40px] w-[90%]" placeholder="Email" onChange={handleChange} value={formData.email}/>
                    ...
                    <button type="submit" className="bg-[#5DF8D8] text-[black] rounded-lg px-3 py-1 border-none outline-none hover:cursor-pointer mx-[auto]">Sign Up</button>
                    <button type="button" className="absolute bottom-[8px] right-[8px] text-sm hover:cursor-pointer" onClick={()=>swap(props.sethasAccount)}>Login</button>
